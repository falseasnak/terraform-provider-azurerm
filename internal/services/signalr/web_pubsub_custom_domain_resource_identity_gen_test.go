	...
	data.ResourceIdentityTest(t, []acceptance.TestStep{
		{
			...
			ConfigStateChecks: []statecheck.StateCheck{
				...
				customstatecheck.ExpectStateContainsIdentityValueAtPath("azurerm_web_pubsub_custom_domain.test", tfjsonpath.New("web_pub_sub_name"), tfjsonpath.New("web_pubsub_id")),
			},
		},
